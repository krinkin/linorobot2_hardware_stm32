...
.PHONY: help test-host libmicroros build-fw renode control agent-roundtrip test-all clean submodules
...
# --- everything ---
test-all: test-host libmicroros build-fw renode control
