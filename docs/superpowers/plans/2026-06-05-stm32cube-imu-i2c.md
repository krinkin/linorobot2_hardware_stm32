# STM32Cube Port -- Plan 6: IMU (MPU6050) over HAL I2C (Phase F5)
...
>
> **Prerequisite:** Plans 1-5 (host tests, F0 link, F2 boot, F3 agent round-trip, F4 control loop).
...
(66.8 KB Flash, hard-float, no libstdc++), F5 control/IMU smoke -- **MPU6050 detected (WHO_AM_I=0x68) +
...
- **F5 test:** a Python MPU6050 mock (`Mocks.DummyI2CSlave @ i2c1 0x68`) answers the firmware's real HAL
...
make imu              # F5 (MPU6050 over real HAL I2C via the Python mock)
```
